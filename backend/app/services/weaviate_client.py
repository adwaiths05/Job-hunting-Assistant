...
class WeaviateClient:
    def __init__(self):
        # Define the class name used in Weaviate
        self.class_name = "Job"  # You can rename this to "JobPosting" or anything consistent with your schema
        ...
        # Connect to Weaviate (local or Docker)
